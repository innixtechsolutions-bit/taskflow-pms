...
namespace TaskFlow.Api.Data.Migrations
{
    ...
    [Migration("20260722165206_AddActivityLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Api.Data.Entities.ActivityLogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskFlow.Api.Data.Entities.Label", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskFlow.Api.Data.Entities.Sprint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskFlow.Api.Data.Entities.WorkItemLabel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskFlow.Api.Data.Entities.ActivityLogEntry", b =>
                {
                    b.HasOne("TaskFlow.Api.Data.Entities.User", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskFlow.Api.Data.Entities.WorkItem", b =>
                {
                    ...
                    b.HasOne("TaskFlow.Api.Data.Entities.Sprint", "Sprint")
                        .WithMany("WorkItems")
            ...
            modelBuilder.Entity("TaskFlow.Api.Data.Entities.WorkItemLabel", b =>
                {
                    b.HasOne("TaskFlow.Api.Data.Entities.Label", "Label")
                        .WithMany("WorkItemLabels")
                        .HasForeignKey("LabelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TaskFlow.Api.Data.Entities.WorkItem", "WorkItem")
                        .WithMany("Labels")
